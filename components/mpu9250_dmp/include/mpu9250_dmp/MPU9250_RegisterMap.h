...
Code modified to work with esp32-idf environment
Quincy Jones @ qjones@c4solutions.net

Development environment specifics:
esp-idf version pre-1.0 "Latest" / 2/13/2016.  Rapidly moving target currently.
SparkFun 9DoF Razor IMU M0

Supported Platforms:
- esp32/esp8266(untested)
******************************************************************************/
